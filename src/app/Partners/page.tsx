...
export default function PartnerPage() {
    ...
    const handleSubmit = () => {
        const pesan =
            'Halo House Essentials, saya tertarik untuk menjadi partner. Berikut detail bisnis saya:%0A%0A' +
            'Nama Bisnis: ' + (isSetNamaBisnis ? isSetNamaBisnis : '-') +
            '%0AAlamat: ' + (isSetAlamat ? isSetAlamat : '-') +
            '%0A%0ATerima kasih.';
    ...
    return (
        ...
        >
            ...
            <div className="relative flex items-center justify-center min-h-screen px-6 md:px-12 lg:pl-20">
                ...
                <div
                    ref={ref}
                    className="flex flex-col justify-center items-center text-center gap-6 max-w-4xl w-full"
                >
                    <motion.h1
                        variants={variants}
                        initial="hidden"
                        ...
                        >
                            <Input
                                ...
                                className="
                                    ...
                                    md:w-[420px]
                                    lg:w-[480px]
                                    rounded-full bg-white/30 backdrop-blur-md border-none 
                                    py-3 px-5 placeholder:text-white/80 text-white shadow-md
                                "
                    ...
                    >
                        <Button
                            ...
                            className="
                                cursor-pointer rounded-full px-8 py-4 text-white font-semibold 
