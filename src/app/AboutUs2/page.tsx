        ...
        <main className="relative w-full bg-cover bg-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 min-h-screen">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 auto-rows-fr">
                    {/* Kotak 1 */}
                    <div className="flex flex-col justify-center p-14 bg-[#FFFCF4] gap-6">
                    ...
                    {/* Kotak 2 */}
                    <div className="flex flex-col justify-center p-16 bg-[#A5D4C6] gap-6">
                    ...
                    {/* Kotak 3 */}
                    <div className="flex flex-col justify-center p-14 bg-[#CBE2F0] gap-6">
